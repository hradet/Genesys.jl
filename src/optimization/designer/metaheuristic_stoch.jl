...
function offline_optimization(ld::Load, pv::Source, liion::Liion,
     designer::MetaHeuristicStochDesigner, grid::Grid, ω_optim::Scenarios,
...
function compute_investment_decisions(y::Int64, s::Int64, ld::Load, pv::Source,
    liion::Liion, grid::Grid, designer::MetaHeuristicStochDesigner, ω_optim::Scenarios, parameters::NamedTuple)
    ϵ = 0.1
...
function compute_investment_decisions(y::Int64, s::Int64, ld::Load, pv::Source,
    ...
    heater::Heater, designer::MetaHeuristicStochDesigner, ω_optim::Scenarios, parameters::NamedTuple)
    ϵ = 0.1
