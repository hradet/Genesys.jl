...
mutable struct AnticipativeOneStageDesigner <: AbstractOneStageStochasticDesigner
    u::NamedTuple
    model::JuMP.Model
...
function onestage_milp_model(ld::Load, pv::Source, liion::Liion,
  designer::AnticipativeOneStageDesigner, grid::Grid, ω_optim::Scenarios,
...
function compute_investment_decisions(y::Int64, s::Int64, ld::Load, pv::Source,
    liion::Liion, grid::Grid, designer::AnticipativeOneStageDesigner, ω_optim::Scenarios, parameters::NamedTuple)
    ϵ = 0.1
