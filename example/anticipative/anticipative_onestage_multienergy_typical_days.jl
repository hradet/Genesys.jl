...
# Offline optimization with TD
timer_offline = @elapsed Genesys.offline_optimization(ld, pv, liion, h2tank, elyz, fc, tes, heater, controller, designer, grid, ω_optim, ntd, outputGUI["parameters"])
...
Genesys.plot_investment_mes(designer, outputGUI["parameters"])
